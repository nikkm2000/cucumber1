...
public class AccountsPageSteps {
	...
	public void user_has_already_logged_in_to_application(DataTable credTable) {
		...
		//DataBaseConnection.getDBConncetionObject();
	...
	public void mAccountPage() {
		DataBaseConnection.getObject();
	}
	...
	public void user_gets_accounts_section(DataTable sectionsTable) {
		...
		AssertJUnit.assertTrue(expAccountSectionsList.containsAll(actualAccountSectionsList));

	}

	@Then("accounts section count should be {int}")
	public void accounts_section_count_should_be(Integer expectedSectionCount) {
		AssertJUnit.assertTrue(accountsPage.getAccountsSectionCount() == expectedSectionCount);
	}
